...
const AboutConference = () => {
  return (
    <section className="p-6 bg-gray-50 px-[140px] py-[64px]">
      <h2 className="text-2xl font-bold mb-4">About Conference</h2>
      <Card className="flex flex-col md:flex-row bg-white shadow-lg rounded-lg overflow-hidden ">
        {" "}
        ...
        <div className="md:w-1/2 p-4">
          ...
          <p className="mt-4 text-gray-700 text-[20px]">
            ...
            Universitas Ahmad Dahlan, Indonesia. The 1<sup>st</sup> ICAT is held
            on the theme of "Artificial Intelligence Applications for a
